...
nholuongut.math({handlebars: hbs});
nholuongut.object({handlebars: hbs});
...
describe('object', function() {
  describe('extend', function() {
    ...
    it('should work as a non-helper util:', function() {
      var actual = nholuongut().extend({a: {b: 'c'}}, {d: {e: 'f'}}, {g: {h: 'i'}});
      assert.deepEqual(actual, { a: { b: 'c' }, d: { e: 'f' }, g: { h: 'i' } });
    });

    it('should skip over sparse objects', function() {
      var actual = nholuongut().extend({a: {b: 'c'}}, null, {g: {h: 'i'}});
