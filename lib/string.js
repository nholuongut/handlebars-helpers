...
nholuongut.append = function(str, suffix) {
...
nholuongut.camelcase = function(str) {
...
nholuongut.capitalize = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.capitalizeAll = function(str) {
  if (!util.isString(str)) return '';
  if (util.isString(str)) {
    return str.replace(/\w\S*/g, function(word) {
      return nholuongut.capitalize(word);
    });
  }
};
...
nholuongut.center = function(str, spaces) {
  if (!util.isString(str)) return '';
  var space = '';
  var i = 0;
  while (i < spaces) {
...
nholuongut.dashcase = function(str) {
  if (!util.isString(str)) return '';
  return utils.changecase(str, function(ch) {
    return '-' + ch;
  });
...
nholuongut.dotcase = function(str) {
  if (!util.isString(str)) return '';
  return utils.changecase(str, function(ch) {
    return '.' + ch;
  });
...
nholuongut.downcase = function() {
  return nholuongut.lowercase.apply(this, arguments);
};
...
nholuongut.ellipsis = function(str, limit) {
  if (util.isString(str)) {
    if (str.length <= limit) {
      return str;
    }
    return nholuongut.truncate(str, limit) + '…';
  }
};
...
nholuongut.hyphenate = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.isString = function(value) {
...
nholuongut.lowercase = function(str) {
...
nholuongut.occurrences = function(str, substring) {
  if (!util.isString(str)) return '';
...
nholuongut.pascalcase = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.pathcase = function(str) {
  if (!util.isString(str)) return '';
  return utils.changecase(str, function(ch) {
    return '/' + ch;
  });
...
nholuongut.plusify = function(str, ch) {
  if (!util.isString(str)) return '';
...
nholuongut.prepend = function(str, prefix) {
...
nholuongut.raw = function(options) {
  var str = options.fn();
...
nholuongut.remove = function(str, ch) {
  if (!util.isString(str)) return '';
...
nholuongut.removeFirst = function(str, ch) {
  if (!util.isString(str)) return '';
  if (!util.isString(ch)) return str;
...
nholuongut.replace = function(str, a, b) {
  if (!util.isString(str)) return '';
...
nholuongut.replaceFirst = function(str, a, b) {
  if (!util.isString(str)) return '';
  if (!util.isString(a)) return str;
  if (!util.isString(b)) b = '';
...
nholuongut.reverse = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.sentence = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.snakecase = function(str) {
  if (!util.isString(str)) return '';
  return utils.changecase(str, function(ch) {
    return '_' + ch;
  });
...
nholuongut.split = function(str, ch) {
  if (!util.isString(str)) return '';
  if (!util.isString(ch)) ch = ',';
  return str.split(ch);
};
...
nholuongut.startsWith = function(prefix, str, options) {
...
nholuongut.titleize = function(str) {
  if (!util.isString(str)) return '';
...
nholuongut.trimLeft = function(str) {
  if (util.isString(str)) {
...
nholuongut.trimRight = function(str) {
  if (util.isString(str)) {
    return str.replace(/\s+$/, '');
  }
};
...
nholuongut.truncate = function(str, limit, suffix) {
  if (util.isString(str)) {
...
nholuongut.truncateWords = function(str, count, suffix) {
...
nholuongut.upcase = function() {
  return nholuongut.uppercase.apply(this, arguments);
};
...
nholuongut.uppercase = function(str) {
  if (util.isObject(str) && str.fn) {
