...
nholuongut.frame = require('handlebars-helper-create-frame');
...
nholuongut.option = function(prop, locals, options) {
...
nholuongut.noop = function(options) {
...
nholuongut.typeOf = require('kind-of');
...
nholuongut.withHash = function(options) {
