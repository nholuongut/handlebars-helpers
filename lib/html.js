...
nholuongut.attr = function(options) {
...
nholuongut.css = function(list, options) {
...
nholuongut.js = function(context) {
...
nholuongut.sanitize = function(str) {
...
nholuongut.ul = function(context, options) {
...
nholuongut.ol = function(context, options) {
...
nholuongut.thumbnailImage = function(context) {
  var figure = '';
  var image = '';
