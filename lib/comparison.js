...
nholuongut.compare = function(a, operator, b, options) {
  /*eslint eqeqeq: 0*/
...
nholuongut.contains = function(collection, value, startIndex, options) {
...
nholuongut.eq = function(a, b, options) {
...
nholuongut.gt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.gte = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.has = function(value, pattern, options) {
...
nholuongut.isFalsey = function(val, options) {
...
nholuongut.isTruthy = function(val, options) {
  return util.value(!utils.falsey(val), this, options);
};
...
nholuongut.ifEven = function(num, options) {
...
nholuongut.ifNth = function(a, b, options) {
...
nholuongut.ifOdd = function(val, options) {
...
nholuongut.is = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.isnt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.lt = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.lte = function(a, b, options) {
  if (arguments.length === 2) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.neither = function(a, b, options) {
  return util.value(!a && !b, this, options);
};
...
nholuongut.not = function(val, options) {
  return util.value(!val, this, options);
};
...
nholuongut.or = function(/* any, any, ..., options */) {
  var len = arguments.length - 1;
  var options = arguments[len];
  var val = false;
...
nholuongut.unlessEq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.unlessGt = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.unlessLt = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.unlessGteq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
...
nholuongut.unlessLteq = function(a, b, options) {
  if (util.isOptions(b)) {
    options = b;
    b = options.hash.compare;
  }
