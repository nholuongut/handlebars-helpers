...
nholuongut.match = function(files, patterns, locals, options) {
...
nholuongut.isMatch = function(files, patterns, locals, options) {
  var opts = util.options(this, locals, options);
...
nholuongut.mm = function() {
  console.log('the {{mm}} helper is depcrecated and will be removed');
  console.log('in handlebars-nholuongut v1.0.0, please use the {{match}}');
  console.log('helper instead.');
  return nholuongut.match.apply(this, arguments);
};
