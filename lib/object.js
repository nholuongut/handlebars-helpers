...
nholuongut.extend = function(/*objects*/) {
...
nholuongut.forIn = function(obj, options) {
...
nholuongut.forOwn = function(obj, options) {
  if (!util.isOptions(options)) {
    return obj.inverse(this);
  }
...
nholuongut.toPath = function(/*prop*/) {
  var prop = [];
...
nholuongut.get = function(prop, context, options) {
...
nholuongut.getObject = function(prop, context) {
...
nholuongut.hasOwn = function(context, key) {
...
nholuongut.isObject = function(value) {
...
nholuongut.JSONparse = function(str, options) {
...
nholuongut.JSONstringify = function(obj, indent) {
...
nholuongut.merge = function(context/*, objects, options*/) {
  var args = [].slice.call(arguments);
  var opts = {};
...
nholuongut.parseJSON = nholuongut.JSONparse;
...
nholuongut.pick = function(props, context, options) {
  var keys = array.arrayify(props);
  var len = keys.length, i = -1;
  var result = {};

  while (++i < len) {
    result = nholuongut.extend({}, result, utils.getObject(context, keys[i]));
  }
...
nholuongut.stringify = nholuongut.JSONstringify;
