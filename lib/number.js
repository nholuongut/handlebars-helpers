...
nholuongut.bytes = function(number, precision, options) {
...
nholuongut.addCommas = function(num) {
...
nholuongut.phoneNumber = function(num) {
  num = num.toString();
...
nholuongut.toAbbr = function(number, precision) {
  if (!utils.isNumber(number)) {
    number = 0;
  }
...
nholuongut.toExponential = function(number, digits) {
  if (!utils.isNumber(number)) {
    number = 0;
  }
...
nholuongut.toFixed = function(number, digits) {
  if (!utils.isNumber(number)) {
    number = 0;
  }
  if (!isNumber(digits)) {
...
nholuongut.toFloat = function(number) {
...
nholuongut.toInt = function(number) {
...
nholuongut.toPrecision = function(number, precision) {
  if (!utils.isNumber(number)) {
    number = 0;
  }
