...
nholuongut.absolute = function(filepath, options) {
...
nholuongut.dirname = function(filepath, options) {
...
nholuongut.relative = function(a, b) {
  if (typeof a !== 'string') {
...
nholuongut.basename = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(utils.expectedType('filepath', 'string', filepath));
  }
...
nholuongut.stem = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(utils.expectedType('filepath', 'string', filepath));
  }
...
nholuongut.extname = function(filepath) {
  if (typeof filepath !== 'string') {
    throw new TypeError(utils.expectedType('filepath', 'string', filepath));
  }
...
nholuongut.resolve = function(filepath) {
...
nholuongut.segments = function(filepath, a, b) {
  if (typeof filepath !== 'string') {
    throw new TypeError(utils.expectedType('filepath', 'string', filepath));
  }
