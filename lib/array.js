...
nholuongut.after = function(array, n) {
...
nholuongut.arrayify = function(value) {
...
nholuongut.before = function(array, n) {
  if (util.isUndefined(array)) return '';
...
nholuongut.eachIndex = function(array, options) {
  var result = '';
...
nholuongut.filter = function(array, value, options) {
  var content = '';
  var results = [];
...
nholuongut.first = function(array, n) {
  if (util.isUndefined(array)) return '';
  if (!utils.isNumber(n)) {
    return array[0];
  }
...
nholuongut.forEach = function(array, options) {
...
nholuongut.inArray = function(array, value, options) {
...
nholuongut.isArray = function(value) {
...
nholuongut.itemAt = function(array, idx) {
...
nholuongut.join = function(array, separator) {
...
nholuongut.equalsLength = function(value, length, options) {
...
nholuongut.last = function(value, n) {
...
nholuongut.length = function(value) {
...
nholuongut.lengthEqual = nholuongut.equalsLength;
...
nholuongut.map = function(array, iter) {
  if (!Array.isArray(array)) return '';
  var len = array.length;
...
nholuongut.pluck = function(arr, prop) {
...
nholuongut.reverse = function(val) {
...
nholuongut.some = function(array, iter, options) {
  if (Array.isArray(array)) {
    for (var i = 0; i < array.length; i++) {
...
nholuongut.sort = function(array, options) {
  if (!Array.isArray(array)) return '';
...
nholuongut.sortBy = function(array, prop, options) {
  if (!Array.isArray(array)) return '';
...
nholuongut.withAfter = function(array, idx, options) {
  if (!Array.isArray(array)) return '';
...
nholuongut.withBefore = function(array, idx, options) {
  if (!Array.isArray(array)) return '';
...
nholuongut.withFirst = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
...
nholuongut.withGroup = function(array, size, options) {
  var result = '';
...
nholuongut.withLast = function(array, idx, options) {
  if (util.isUndefined(array)) return '';
  array = util.result(array);
...
nholuongut.withSort = function(array, prop, options) {
  if (util.isUndefined(array)) return '';
  var result = '';
...
nholuongut.unique = function(array, options) {
  if (util.isUndefined(array)) return '';
